...
export class PaymentsController {
	...
	handleWaveWebhook(
		...
		return this.paymentsService.handleWaveWebhook(signature || '', rawBody, body);
	}
	...
	@HttpCode(HttpStatus.OK)
	handleOrangeMoneyWebhook(@Body() body: any) {
		return this.paymentsService.handleOrangeMoneyWebhook(body);
	}
}
